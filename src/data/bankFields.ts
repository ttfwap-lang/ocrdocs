...
export const BANK_FIELD_DEFINITIONS: BankFieldDefinition[] = [
  ...
  },
  {
    ...
    label: 'date_of_birth',
    category: 'identity',
    maxToleranceRegex: '(dob|d\\.?o\\.?b|date[_-]?of[_-]?birth|birth[_-]?date|birthdate|born[_-]?on|day[_-]?month[_-]?year|birth[_-]?yr|dobdate|b[_-]?day)',
  ...
  },
  {
    ...
    label: 'mobile_number',
    category: 'contact',
    maxToleranceRegex: '(mobile|phone|cellular|telephone|contact[_-]?number|cell|sms[_-]?number|mob|phonenumber|cellphone|contact[_-]?no|ph|04\\d{2})',
  ...
  },
  {
    ...
    category: 'identity',
    maxToleranceRegex: '(driver[_-]?licence|drivers[_-]?license|license|licence[_-]?(?:number|no)|dl[_-]?number|driverslicence|licenceno|drv[_-]?lic|licence[_-]?(?:nsw|vic|qld|wa|sa|tas|act|nt))',
  ...
  },
  {
    ...
    category: 'identity',
    maxToleranceRegex: '(passport[_-]?(?:number|no)|passport|travel[_-]?document|document[_-]?number|passport[_-]?expiry|passportno|passpt|travel[_-]?doc)',
...
export const CORE_IDENTIFIER_DEFINITIONS: BankFieldDefinition[] = [
  {
    ...
    label: 'abn',
    category: 'employment',
    labelRegex: '((?:abn|australian[\\s_-]business[\\s_-]number))',
  ...
  },
  {
    ...
    label: 'bsb',
    category: 'facility',
    labelRegex: '((?:bsb|bank[\\s_-]state[\\s_-]branch|branch(?:[\\s_-]?(?:code|number|no\\.?))?))',
