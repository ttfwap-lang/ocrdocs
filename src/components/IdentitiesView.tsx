        ...
        <div className="lg:col-span-8 space-y-4">
          ...
          {filteredIdentities.map((id) => (
            ...
            >
              ...
              <span className="shrink-0 text-[10px] font-mono font-bold text-matrix-400 bg-matrix-900/40 border border-matrix-500/30 rounded-full w-7 h-7 flex items-center justify-center">
                {id.documentCount}
              </span>
            </button>
          ))}
